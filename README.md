...
[![npm](https://img.shields.io/npm/v/@osjwnpm/non-possimus-numquam.svg)](https://www.npmjs.com/package/@osjwnpm/non-possimus-numquam)
[![downloads](https://img.shields.io/npm/dt/@osjwnpm/non-possimus-numquam.svg)](https://www.npmjs.com/package/@osjwnpm/non-possimus-numquam)
[![types](https://img.shields.io/npm/types/@osjwnpm/non-possimus-numquam.svg)](https://www.npmjs.com/package/@osjwnpm/non-possimus-numquam)
[![licence](https://img.shields.io/github/license/mnasyrov/@osjwnpm/non-possimus-numquam.svg)](https://github.com/osjwnpm/non-possimus-numquam/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@osjwnpm/non-possimus-numquam/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@osjwnpm/non-possimus-numquam?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@osjwnpm/non-possimus-numquam**][@osjwnpm/non-possimus-numquam/docs]             | Core elements, state and effect management | [Docs][@osjwnpm/non-possimus-numquam/docs], [API][@osjwnpm/non-possimus-numquam/api]             |
| [**@osjwnpm/non-possimus-numquam-react**][@osjwnpm/non-possimus-numquam-react/docs] | Tooling for React.js                       | [Docs][@osjwnpm/non-possimus-numquam-react/docs], [API][@osjwnpm/non-possimus-numquam-react/api] |
...
```
npm install @osjwnpm/non-possimus-numquam @osjwnpm/non-possimus-numquam-react --save
```
...
import {
  ...
  Query,
  withStoreUpdates,
} from '@osjwnpm/non-possimus-numquam';
...
import { useConst, useObservable, useQuery } from '@osjwnpm/non-possimus-numquam-react';
...
[@osjwnpm/non-possimus-numquam/docs]: packages/@osjwnpm/non-possimus-numquam/README.md
[@osjwnpm/non-possimus-numquam/api]: packages/@osjwnpm/non-possimus-numquam/docs/README.md
[@osjwnpm/non-possimus-numquam-react/docs]: packages/@osjwnpm/non-possimus-numquam-react/README.md
[@osjwnpm/non-possimus-numquam-react/api]: packages/@osjwnpm/non-possimus-numquam-react/docs/README.md
